    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-slate-200 shadow-sm">
      ...
      <div className="bg-primary-900 text-white text-xs py-1.5 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-4 text-slate-300">
            ...
            <span>•</span>
            <span className="text-amber-300 font-medium">SaaS para Advogados & Imobiliárias</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-700">
          <Link href="#certidoes" className="hover:text-primary-600 transition-colors">
            Certidões
          </Link>
          <Link href="#como-funciona" className="hover:text-primary-600 transition-colors">
            Como Funciona
          </Link>
          <Link href="#b2b" className="flex items-center gap-1.5 text-primary-800 hover:text-amber-600 transition-colors">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/minha-conta"
            className="flex items-center gap-1.5 text-xs font-semibold text-slate-700 hover:text-primary-800 px-3 py-2 rounded-lg hover:bg-slate-100 transition-colors"
          >
