...
export function PartnerGate({
  ...
  React.useEffect(() => {
    if (!loading && !isPartner) setOpen(true);
  }, [isPartner, loading]);
      ...
      <div className="max-w-3xl space-y-3">
        ...
        {children || (
          <p className="text-sm text-neutral-600">
            Módulo liberado no plano empresa parceira. A operação completa entra na próxima etapa.
          </p>
        )}
      </div>
    );
    ...
    <div className="max-w-lg rounded-2xl border border-neutral-200 bg-neutral-0 p-6 space-y-4">
      ...
      <div>
        ...
        <p className="text-sm text-neutral-600 mt-1">
          Disponível no plano empresa parceira, com CNPJ verificado na Receita Federal.
        </p>
      </div>
